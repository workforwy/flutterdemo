...
void test() {
  ...
  Color color1 = const Color(0xFFFFB5B5);
  ...
  // 从红色到蓝色，线性插值系数为0.5
  Color color4 =
      Color.lerp(const Color(0x88FF0000), const Color(0x880000FF), 0.5);
  ...
  Color color5 =
      Color.alphaBlend(const Color(0x88FF0000), const Color(0x880000FF));
